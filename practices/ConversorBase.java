package ArquiComputadoras;

public class ConversorBase extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        label4.setFont(new java.awt.Font("Arial", 0, 48)); // NOI18N
        label4.setText("Conversor de Bases");

        label1.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        label1.setText("Introduce un numero a convertir");

        label2.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        label2.setText("Escrito en base");

        label3.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        label3.setText("Para convertir  este número a base");
        ...
        label7.setText("escrito en base  ");
        ...
        label11.setText("(2 para \"binario\",8 \"octal\", 10 \"Decimal\", 16 \"hexadecimal\")");

        label12.setText("(2 para \"binario\",8 \"octal\", 10 \"Decimal\", 16 \"hexadecimal\")");
        ...
        jTextField1.getAccessibleContext().setAccessibleName("numero");
        jTextField3.getAccessibleContext().setAccessibleName("baseOrigen");
        jTextField4.getAccessibleContext().setAccessibleName("baseDestino");
        ...
        button1.getAccessibleContext().setAccessibleName("convertir");
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        int baseOrigen = Integer.parseInt(jTextField3.getText());
        int baseDestino = Integer.parseInt(jTextField4.getText());

        // Validar las bases
        if (baseOrigen < 2 || baseOrigen > 36 || baseDestino < 2 || baseDestino > 36) {
            jTextField5.setText("Base inválida");
            jTextField6.setText("");
            jTextField7.setText("");
            jTextField2.setText("");
            return;
        ...
        // Establecer los resultados en los campos de texto correspondientes
        jTextField5.setText(numero); // El número original
        jTextField6.setText(Integer.toString(baseOrigen)); // La base original
        jTextField7.setText(resultado); // El resultado de la conversión
        jTextField2.setText(Integer.toString(baseDestino)); // La base destino
    }

// Métodos de conversión (los mismos que en tu código original)
    private int convertirABaseDecimal(String numero, int baseOrigen) {
        return Integer.parseInt(numero, baseOrigen);
    }

    private String convertirDeDecimalABase(int numeroDecimal, int baseDestino) {
        return Integer.toString(numeroDecimal, baseDestino).toUpperCase();
    }

    private String convertirNumero(String numero, int baseOrigen, int baseDestino) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConversorBase().setVisible(true);
            }
        });
    }
